...
namespace SwitchKnifeApp
{
    class Program
    {
        ...
        {
            Console.WriteLine("map_test_to_class|csproj_find_not_present_file|file_remover|csv_splitter|csv-change|csv-validate-keys|csv-merge|char-case|lsh-serach|resx-key");
